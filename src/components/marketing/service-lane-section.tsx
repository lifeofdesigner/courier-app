      ...
      <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
        ...
        <ol className="grid gap-4">
          {steps.map((step, index) => (
            ...
            >
              <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-white text-sm font-bold text-navy shadow-sm">
                {index + 1}
              </span>
              <div>
                <h3 className="flex items-center gap-2 font-heading text-lg font-bold tracking-tight text-navy">
                  <CheckCircle2
                    aria-hidden="true"
