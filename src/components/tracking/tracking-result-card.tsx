    ...
    <div className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-sm lg:p-8">
      ...
      <div className="mt-8 grid gap-5 lg:grid-cols-3">
        <div className="rounded-2xl bg-slate-50 p-4">
          ...
          <p className="mt-3 text-sm font-semibold text-navy">Route</p>
        ...
        <div className="rounded-2xl bg-slate-50 p-4">
          ...
          <p className="mt-3 text-sm font-semibold text-navy">Service</p>
          <p className="mt-2 text-sm leading-6 text-slate-600">
            {transportMode.label} -{" "}
            {formatModeAwareServiceType(
      ...
      <div className="mt-6 flex items-start gap-3 rounded-2xl border border-slate-100 bg-white p-4">
        ...
        <p className="text-sm leading-7 text-slate-600">
          Delivery for <span className="font-semibold text-navy">{shipment.recipientName}</span>{" "}
